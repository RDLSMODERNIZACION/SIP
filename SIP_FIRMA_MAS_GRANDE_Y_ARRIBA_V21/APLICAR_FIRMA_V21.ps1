...
$backup = "$pdfService.backup_v21_$stamp"
...
& python (Join-Path $PSScriptRoot "patch_v21.py") $pdfService
if ($LASTEXITCODE -ne 0) { throw "Falló patch_v21.py" }
...
Write-Host " FIRMA V21 MAS GRANDE Y MAS ARRIBA APLICADA" -ForegroundColor Green
Write-Host "====================================================" -ForegroundColor Green
Write-Host "Regenerá el PDF para revisar el tamaño." -ForegroundColor Cyan
