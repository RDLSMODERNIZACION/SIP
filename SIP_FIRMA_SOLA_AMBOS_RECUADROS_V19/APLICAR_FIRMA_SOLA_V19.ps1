...
$backup = "$pdfService.backup_v19_$stamp"
...
& python (Join-Path $PSScriptRoot "patch_v19.py") $pdfService
if ($LASTEXITCODE -ne 0) { throw "Falló patch_v19.py" }
...
Write-Host " FIRMA SOLA V19 APLICADA CORRECTAMENTE" -ForegroundColor Green
Write-Host "====================================================" -ForegroundColor Green
Write-Host "En ambos recuadros: firma sola, grande y centrada." -ForegroundColor Cyan
