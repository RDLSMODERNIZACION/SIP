...
$backup = "$pdfService.backup_recuadro_firma_v13_$stamp"
...
& python (Join-Path $PSScriptRoot "patch_recuadro_firma.py") $pdfService
if ($LASTEXITCODE -ne 0) {
    throw "Falló patch_recuadro_firma.py"
}
...
Write-Host " FIRMA EN RECUADRO V13 APLICADA CORRECTAMENTE" -ForegroundColor Green
Write-Host "====================================================" -ForegroundColor Green
Write-Host ""
Write-Host "Ahora regenerá un PDF y revisá el recuadro 'FIRMA Y SELLO DEL RESPONSABLE'." -ForegroundColor Cyan
