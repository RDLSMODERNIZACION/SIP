...
$backup = "$pdfService.backup_v17_$stamp"
...
Write-Host "   [OK] Imágenes recortadas copiadas" -ForegroundColor Green

& python (Join-Path $PSScriptRoot "patch_v17.py") $pdfService
if ($LASTEXITCODE -ne 0) { throw "Falló patch_v17.py" }
...
Write-Host " FIRMA Y SELLO V17 CORREGIDOS" -ForegroundColor Green
Write-Host "====================================================" -ForegroundColor Green
Write-Host "Regenerá el PDF. Ahora los PNG están recortados y deberían verse en tamaño normal." -ForegroundColor Cyan
