...
$backup = "$pdfService.backup_footer_v11_$stamp"
...
Write-Host " FOOTER CERTIFICADO V11 APLICADO CORRECTAMENTE" -ForegroundColor Green
Write-Host "====================================================" -ForegroundColor Green
Write-Host ""
Write-Host "Ahora regenerá un PDF de certificado y revisá el pie." -ForegroundColor Cyan
Write-Host ""
Write-Host "Si está bien:" -ForegroundColor White
Write-Host "git add back/app/services/pdf_service.py back/app/static/certificate_assets/" -ForegroundColor White
Write-Host "git commit -m `"feat: agregar firma y sello al pie del certificado`"" -ForegroundColor White
